...
exports.getPaginatedResults = void 0;
const getPaginatedResults = async (fn) => {
    var _a, e_1, _b, _c;
    const EMPTY = Symbol("empty");
    const res = [];
    try {
        for (var _d = true, _e = __asyncValues((function () {
            return __asyncGenerator(this, arguments, function* () {
                let NextMarker = EMPTY;
                let count = 0;
                while (NextMarker || NextMarker === EMPTY) {
                    const { marker, results, count: ct } = yield __await(fn(NextMarker !== EMPTY ? NextMarker : undefined, count));
